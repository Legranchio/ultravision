<div class="s-block">
	<div class="title-block"><span>Восстановление забытого пароля</span></div>
	<div class="s-block-content">
		<table class="user-info-table">
			...
			<tr>
				<td></td>
				<td><input type="image" src="{THEME}/images/ok.jpg" style="border: 0;background: none;" value="Отправить" name="submit" alt="Отправить"></td>
			</tr>
		</table>
	</div>
</div>