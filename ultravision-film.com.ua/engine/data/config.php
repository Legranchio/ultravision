...
'home_title' => 'Официальный Представитель Ultra Vision Window Film тонировочные пленки в Украине.',

'http_home_url' => 'http://ultravision-film.com.ua/',

'charset' => 'utf-8',

'description' => 'Официальный Представитель Ultra Vision Window Film тонировочные пленки в Украине.',

'keywords' => 'тонировочные пленки, купить пленку, купить пленку на авто, купить тонировочную пленку, тонировка авто киев,тонировочная пленка, ultra vision, тонировка,пленка на авто,пленка для авто, солнцезащитная пленка, пленка для тонировки,пленка для окон, тонировочная пленка для окон, купить пленку для тонировки, авто пленка, тонировочная пленка купить, тонировка по госту,тонировка хамелеон,тонировочная пленка купить киев, тонировочная пленка для окон купи',

'short_title' => 'Официальный Представитель Ultra Vision Window Film тонировочные пленки в Украине.',
...
'offline_reason' => 'Сайт ultravision-film.com.ua перенесен и установлен на сервер. Ожидается отклика BD mySQL. Ждите......',
...
'admin_mail' => 'nazarik94@yandex.ru',
