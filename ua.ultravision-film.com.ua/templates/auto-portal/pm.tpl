<div class="s-block">
	...
	<div class="s-block-content">
		...
		<div class="pm-block-menu">[inbox]Входящие сообщения[/inbox] | [outbox]Отправленные сообщения[/outbox] | [new_pm]Отправить сообщение[/new_pm]</div>
		[pmlist]
		<div class="pm-content">
		<strong>Список сообщений:</strong><br /><br /><br />
		{pmlist}</div>
		[/pmlist]
		[newpm]
